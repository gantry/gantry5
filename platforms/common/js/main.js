...
(function (modules, global) {
    ...
    '8': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), $ = require('l'), zen = require('m'), domready = require('p'), storage = require('d')(), modal = require('a').modal, size = require('13'), merge = require('u'), guid = require('14'), request = require('w')(), History = require('15'), AjaxURL = require('y');
    ...
    'b': function (require, module, exports, global) {
        'use strict';
        var prime = require('k');
        var forEach = require('f'), map = require('i'), filter = require('g'), every = require('1c'), some = require('1d');
    ...
    'c': function (require, module, exports, global) {
        ...
        var prime = require('k'), defer = require('17');
    ...
    'z': function (require, module, exports, global) {
        ...
        var forOwn = require('22'), forEach = require('23'), size = require('13'), isArray = require('24'), flatten = require('25'), guid = require('14'), set = require('26'), unset = require('27'), get = require('28');
        require('2');
        require('6');
        var rpad = require('29'), repeat = require('2a');
        $.implement({
            empty: function () {
                return this.forEach(function (node) {
                    var first;
    ...
    '12': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), $ = require('l'), zen = require('m'), Emitter = require('c'), Bound = require('n'), Options = require('o'), Blocks = require('21'), DragDrop = require('2c'), Resizer = require('2d'), Eraser = require('2e'), get = require('28'), every = require('2f'), isArray = require('24'), isObject = require('1s'), equals = require('2g');
    ...
    '2c': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Emitter = require('c'), Bound = require('n'), Options = require('o'), bind = require('q'), contains = require('3r'), DragEvents = require('3m'), $ = require('l');
        require('3');
        require('4');
    ...
    '2d': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('3m'), prime = require('k'), Emitter = require('c'), Bound = require('n'), Options = require('o'), bind = require('q'), isString = require('3n'), nMap = require('3o'), clamp = require('3p'), precision = require('3q'), get = require('28'), $ = require('l');
        require('3');
        require('4');
    ...
    '34': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Options = require('o'), Bound = require('n'), Emitter = require('c'), guid = require('14'), zen = require('m'), $ = require('1'), get = require('28'), has = require('3i'), set = require('26');
        require('6');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '35': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34');
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '36': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34'), Bound = require('n'), Grid = require('38'), $ = require('1'), zen = require('m'), bind = require('q');
        require('5');
        var UID = 0;
    ...
    '37': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Section = require('36');
    ...
    '39': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34'), $ = require('l'), zen = require('m');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '3a': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Atom = require('35'), bind = require('q'), precision = require('3q');
        var UID = 0;
