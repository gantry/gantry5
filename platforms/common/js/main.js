...
(function (modules, global) {
    ...
    '8': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), $ = require('l'), zen = require('m'), domready = require('p'), storage = require('h')(), modal = require('a').modal, size = require('13'), merge = require('u'), guid = require('14'), request = require('w')(), History = require('15'), getAjaxSuffix = require('y');
        require('7');
    ...
    '9': function (require, module, exports, global) {
        'use strict';
        var ready = require('p'), json = require('x'), $ = require('2'), modal = require('a').modal, request = require('w'), zen = require('m'), getAjaxSuffix = require('y'), Builder = require('z'), History = require('10'), LMHistory = require('11'), LayoutManager = require('12');
        require('7');
    ...
    'l': function (require, module, exports, global) {
        'use strict';
        var $ = require('1'), moofx = require('1h'), map = require('r'), slick = require('j');
    ...
    '12': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), $ = require('l'), zen = require('m'), Emitter = require('g'), Bound = require('n'), Options = require('o'), Blocks = require('21'), DragDrop = require('2b'), Resizer = require('2c'), Eraser = require('2d'), get = require('28'), every = require('2e'), isArray = require('24'), isObject = require('1s'), equals = require('2f');
    ...
    '1e': function (require, module, exports, global) {
        'use strict';
        var kindOf = require('1l'), now = require('2n'), forEach = require('d'), indexOf = require('f');
        var callbacks = {
                timeout: {},
                frame: [],
                immediate: []
    ...
    '2c': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('3n'), prime = require('k'), Emitter = require('g'), Bound = require('n'), Options = require('o'), bind = require('q'), isString = require('3o'), nMap = require('3p'), clamp = require('3q'), precision = require('3r'), get = require('28'), $ = require('l');
        require('3');
        require('4');
    ...
    '34': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Options = require('o'), Bound = require('n'), Emitter = require('g'), guid = require('14'), zen = require('m'), $ = require('1'), get = require('28'), has = require('3i'), set = require('26');
        require('6');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '36': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34'), Bound = require('n'), Grid = require('38'), $ = require('1'), zen = require('m'), bind = require('q'), getAjaxURL = require('4c');
        require('5');
        var UID = 0;
    ...
    '38': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34'), $ = require('1'), getAjaxURL = require('4c');
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '39': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Base = require('34'), $ = require('l'), zen = require('m'), precision = require('3r');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '3a': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Atom = require('35'), bind = require('q'), precision = require('3r'), getAjaxURL = require('4c');
        var UID = 0;
