...
(function (modules, global) {
    ...
    '15': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), $ = require('l'), zen = require('m'), Emitter = require('g'), Bound = require('n'), Options = require('o'), Blocks = require('26'), DragDrop = require('2f'), Resizer = require('2g'), Eraser = require('2h'), get = require('2c'), every = require('2i'), isArray = require('23'), isObject = require('1s'), equals = require('2j');
