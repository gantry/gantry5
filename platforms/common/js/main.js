...
(function (modules, global) {
    ...
    '0': function (require, module, exports, global) {
        ...
        ready(function () {
            ...
            body.delegate('click', '.button-save', function (e, element) {
                ...
                var data = {}, type = element.data('save'), extras = '', page = $('[data-lm-root]') ? 'layout' : $('[data-mm-id]') ? 'menu' : 'other', saveURL = window.location.href + getAjaxSuffix();
                switch (page) {
                case 'layout':
    ...
    '3': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Emitter = require('u');
        var isObject = require('v'), isString = require('w'), isArray = require('x'), isFunction = require('y'), trim = require('z'), upperCase = require('10'), forIn = require('11'), mixIn = require('12'), remove = require('13'), forEach = require('14');
    ...
    '4': function (require, module, exports, global) {
        'use strict';
        var Modal = require('m'), Selectize = require('n');
        module.exports = {
            modal: new Modal(),
            togglers: require('o'),
            selectize: Selectize,
    ...
    '6': function (require, module, exports, global) {
        var toString = require('q');
        var WHITE_SPACES = require('1g');
        var ltrim = require('1h');
        var rtrim = require('1i');
    ...
    '8': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('a'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), zen = require('k'), contains = require('15'), size = require('16'), trim = require('6'), forEach = require('17'), getAjaxSuffix = require('7'), Builder = require('18'), History = require('19'), LMHistory = require('1a'), LayoutManager = require('1b'), SaveState = require('1c');
        require('g');
    ...
    '9': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), MenuManager = require('1d'), $ = require('1'), zen = require('k'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), deepEquals = require('1e'), trim = require('6'), clamp = require('1f'), contains = require('15'), getAjaxSuffix = require('7');
        var menumanager, map;
    ...
    'a': function (require, module, exports, global) {
        'use strict';
        var $ = require('s');
        var trim = require('z'), forEach = require('14'), filter = require('1k'), indexOf = require('1l');
        $.implement({
    ...
    'f': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('a'), storage = require('1j'), deepEquals = require('1e'), invoke = require('1m'), History = require('19');
    ...
    'g': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), storage = require('1j')(), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), domready = require('2'), bind = require('20'), map = require('21'), forEach = require('22'), last = require('23'), merge = require('1o'), isFunct = require('24'), request = require('3');
    ...
    'h': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), domready = require('2'), storage = require('1j')(), modal = require('4').modal, size = require('16'), merge = require('1o'), guid = require('1p'), toQueryString = require('1q'), contains = require('1r'), request = require('3')(), History = require('19'), getAjaxSuffix = require('7'), mm = require('9');
        require('g');
        var ERROR = false;
    ...
    'i': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('a'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), zen = require('k'), contains = require('15'), size = require('16'), getAjaxSuffix = require('7');
        require('g');
        ready(function () {
            var body = $('body');
    ...
    'j': function (require, module, exports, global) {
        'use strict';
        module.exports = {
            colorpicker: require('1s'),
            fonts: require('1t'),
            menu: require('1u'),
            icons: require('1v'),
            filepicker: require('1w'),
            collections: require('1x')
        };
    },
    'k': function (require, module, exports, global) {
        'use strict';
        var forEach = require('14'), map = require('25');
        var parse = require('26');
        var $ = require('s');
    ...
    'm': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), storage = require('1j')(), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), domready = require('2'), bind = require('20'), map = require('21'), forEach = require('22'), last = require('23'), merge = require('1o'), request = require('3');
    ...
    'n': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), ready = require('2'), zen = require('k'), sifter = require('2c'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), $ = require('1n'), moofx = require('l'), bind = require('20'), forEach = require('17'), indexOf = require('2d'), last = require('23'), debounce = require('2e'), isArray = require('2f'), isBoolean = require('2g'), merge = require('1o'), unset = require('2h'), size = require('2i'), values = require('2j'), escapeHTML = require('2k'), trim = require('6');
    ...
    'p': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), zen = require('k'), $ = require('1n'), storage = require('1j')(), bind = require('20'), merge = require('1o');
    ...
    's': function (require, module, exports, global) {
        'use strict';
        var prime = require('t');
        var forEach = require('14'), map = require('25'), filter = require('1k'), every = require('2o'), some = require('2p');
    ...
    't': function (require, module, exports, global) {
        'use strict';
        var hasOwn = require('2l'), mixIn = require('12'), create = require('2m'), kindOf = require('2n');
    ...
    'u': function (require, module, exports, global) {
        'use strict';
        var indexOf = require('1l'), forEach = require('14');
        var prime = require('t'), defer = require('2r');
    ...
    'z': function (require, module, exports, global) {
        var toString = require('2t');
        var WHITE_SPACES = require('2u');
        var ltrim = require('2v');
        var rtrim = require('2w');
        function trim(str, chars) {
            str = toString(str);
            chars = chars || WHITE_SPACES;
            return ltrim(rtrim(str, chars), chars);
    ...
    '17': function (require, module, exports, global) {
        var make = require('3m');
        var arrForEach = require('22');
        var objForEach = require('2z');
        module.exports = make(arrForEach, objForEach);
    },
    '18': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1'), Emitter = require('u');
        var Blocks = require('2y');
        var forOwn = require('2z'), forEach = require('17'), size = require('16'), isArray = require('2f'), flatten = require('30'), guid = require('1p'), set = require('31'), unset = require('2h'), get = require('r'), deepFillIn = require('32'), omit = require('33');
        require('a');
        require('e');
        var rpad = require('34'), repeat = require('35');
        $.implement({
            empty: function () {
                return this.forEach(function (node) {
                    var first;
    ...
    '19': function (require, module, exports, global) {
        'use strict';
        var console = window.console || undefined, document = window.document, navigator = window.navigator, sessionStorage = false, setTimeout = window.setTimeout, clearTimeout = window.clearTimeout, setInterval = window.setInterval, clearInterval = window.clearInterval, JSON = window.JSON, alert = window.alert, History = window.History = require('3j') || {}, history = window.history;
        try {
    ...
    '1a': function (require, module, exports, global) {
        var prime = require('t'), Emitter = require('u'), slice = require('36'), merge = require('1o'), deepEquals = require('1e');
    ...
    '1b': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), Blocks = require('2y'), DragDrop = require('39'), Resizer = require('3a'), Eraser = require('3b'), get = require('r'), keys = require('3c'), every = require('3d'), precision = require('3e'), isArray = require('2f'), deepEquals = require('1e'), find = require('3f'), isObject = require('3g');
        var singles = {
                disable: function () {
    ...
    '1c': function (require, module, exports, global) {
        var prime = require('t'), deepClone = require('37'), objectDiff = require('38');
    ...
    '1d': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), DragDrop = require('39'), Resizer = require('3h'), get = require('r'), every = require('3d'), isArray = require('2f'), isObject = require('3g'), deepClone = require('37'), equals = require('3i');
    ...
    '1n': function (require, module, exports, global) {
        'use strict';
        var $ = require('1'), moofx = require('l'), map = require('21'), series = require('3o'), slick = require('2b'), zen = require('k'), progresser = require('3p');
        ...
        $.implement({
            ...
            showIndicator: function (klass, keepIcon) {
                ...
                this.gHadIcon = !!icon;
                if (!icon) {
                    if (!this.find('span') && !this.children()) {
                        zen('span').text(this.text()).top(this.empty());
                    }
                    icon = zen('i');
                    icon.top(this);
                }
                if (!this.gIndicator) {
                    this.gIndicator = icon.attribute('class') || true;
                }
            ...
            hideIndicator: function () {
                ...
                if (!this.gHadIcon) {
                    ...
                    icon.attribute('class', this.gIndicator);
                }
    ...
    '1p': function (require, module, exports, global) {
        var randHex = require('3r');
        var choice = require('3s');
        function guid() {
    ...
    '1s': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), $ = require('1'), ready = require('2'), zen = require('k'), DragEvents = require('3t'), forEach = require('17'), bind = require('20'), clamp = require('1f');
        var isFirefox = navigator.userAgent.toLowerCase().indexOf('firefox') > -1;
    ...
    '1t': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), zen = require('k'), storage = require('1j')(), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), domready = require('2'), bind = require('20'), map = require('21'), forEach = require('22'), contains = require('15'), last = require('23'), split = require('3u'), removeAll = require('3v'), insert = require('3w'), find = require('3x'), combine = require('3y'), merge = require('1o'), unhyphenate = require('3z'), properCase = require('40'), trim = require('6'), modal = require('4').modal, async = require('41'), request = require('3'), wf = require('42');
        require('43');
        var Fonts = new prime({
                mixin: Bound,
                inherits: Emitter,
    ...
    '1v': function (require, module, exports, global) {
        'use strict';
        var $ = require('1n'), domready = require('2'), modal = require('4').modal, getAjaxSuffix = require('7'), getAjaxURL = require('44').global, trim = require('6'), contains = require('15');
        domready(function () {
            var body = $('body');
            ...
            body.delegate('click', '[data-g5-iconpicker]', function (event, element) {
                ...
                modal.open({
                    ...
                    remoteLoaded: function (response, content) {
                        var html, large, container = content.elements.content, icons = container.search('[data-icon]');
    ...
    '1w': function (require, module, exports, global) {
        'use strict';
        var $ = require('1n'), prime = require('t'), request = require('3'), zen = require('k'), domready = require('2'), bind = require('20'), rtrim = require('1i'), deepClone = require('37'), deepFillIn = require('32'), modal = require('4').modal, getAjaxSuffix = require('7'), getAjaxURL = require('44').global, dropzone = require('45');
    ...
    '1x': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('1'), zen = require('k'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), lastItem = require('23'), indexOf = require('2d'), simpleSort = require('46'), trim = require('6'), getAjaxSuffix = require('7');
        require('d');
        ready(function () {
            var body = $('body');
            ...
            body.delegate('click', '[data-collection-addnew]', function (event, element) {
                var param = element.parent('.settings-param'), list = param.find('ul'), dataField = param.find('[data-collection-data]'), tmpl = param.find('[data-collection-template]'), items = list.search('> [data-collection-item]') || [], last = $(lastItem(items));
                ...
                if (!items.length) {
                    list.find('[data-collection-editall]').style('display', 'inline-block');
                }
                title = clone.find('a');
    ...
    '29': function (require, module, exports, global) {
        ...
        var prime = require('4c');
        var camelize = require('4d'), clean = require('4e'), capitalize = require('4f'), hyphenateString = require('4g');
        var map = require('4h'), forEach = require('4i'), indexOf = require('4b');
        var elements = require('4j');
        var fx = require('2a');
    ...
    '2a': function (require, module, exports, global) {
        'use strict';
        var prime = require('4c'), requestFrame = require('28').request, bezier = require('4l');
        var map = require('4h');
    ...
    '2b': function (require, module, exports, global) {
        'use strict';
        module.exports = 'document' in global ? require('4m') : { parse: require('26') };
    },
    ...
    '2r': function (require, module, exports, global) {
        'use strict';
        var kindOf = require('2n'), now = require('4o'), forEach = require('14'), indexOf = require('1l');
        var callbacks = {
                timeout: {},
                frame: [],
                immediate: []
    ...
    '39': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), bind = require('20'), contains = require('15'), DragEvents = require('3t'), $ = require('1n');
        require('b');
        require('c');
    ...
    '3a': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('3t'), prime = require('t'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), bind = require('20'), isString = require('57'), nMap = require('58'), clamp = require('1f'), precision = require('3e'), get = require('r'), $ = require('1n');
        require('b');
        require('c');
    ...
    '3b': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1n'), Emitter = require('u'), Bound = require('1y'), Options = require('1z');
    ...
    '3n': function (require, module, exports, global) {
        var identity = require('5d');
        var prop = require('5e');
        var deepMatches = require('5f');
    ...
    '3p': function (require, module, exports, global) {
        'use strict';
        var $ = require('1'), prime = require('t'), Emitter = require('u'), Bound = require('1y'), Options = require('1z'), zen = require('k'), moofx = require('l'), bind = require('20'), isArray = require('2f'), isNumber = require('5c');
    ...
    '40': function (require, module, exports, global) {
        var toString = require('q');
        var lowerCase = require('5j');
        var upperCase = require('5k');
    ...
    '4c': function (require, module, exports, global) {
        'use strict';
        var hasOwn = require('5s'), forIn = require('5t'), mixIn = require('5u'), filter = require('5v'), create = require('5w'), type = require('5x');
    ...
    '4j': function (require, module, exports, global) {
        'use strict';
        var prime = require('4c'), forEach = require('4i'), map = require('4h'), filter = require('5z'), every = require('60'), some = require('61');
        var uniqueIndex = 0;
        var uniqueID = function (n) {
    ...
    '4p': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Options = require('1z'), Bound = require('1y'), Emitter = require('u'), guid = require('1p'), zen = require('k'), $ = require('1'), get = require('r'), has = require('4n'), set = require('31');
        require('e');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '4q': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1'), Base = require('4p'), zen = require('k'), getAjaxURL = require('44').config;
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '4r': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Base = require('4p'), Bound = require('1y'), Grid = require('4t'), $ = require('1'), zen = require('k'), bind = require('20'), getAjaxURL = require('44').config;
        require('d');
        var UID = 0;
    ...
    '4s': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Section = require('4r');
    ...
    '4t': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Base = require('4p'), $ = require('1'), getAjaxURL = require('44').config;
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '4u': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Base = require('4p'), $ = require('1');
    ...
    '4v': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Base = require('4p'), $ = require('1n'), zen = require('k'), precision = require('3e'), bind = require('20');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '4w': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), $ = require('1'), Atom = require('4q'), bind = require('20'), precision = require('3e'), getAjaxURL = require('44').config;
        var UID = 0;
    ...
    '4x': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), trim = require('6'), Particle = require('4w');
        var UID = 0;
    ...
    '4y': function (require, module, exports, global) {
        'use strict';
        var prime = require('t'), Particle = require('4w');
    ...
    '5g': function (require, module, exports, global) {
        var MIN_INT = require('69');
        var MAX_INT = require('6a');
        var rand = require('6b');
    ...
    '6h': function (require, module, exports, global) {
        'use strict';
        var forIn = require('5t'), hasOwn = require('5s');
