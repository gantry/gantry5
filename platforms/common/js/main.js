...
(function (modules, global) {
    ...
    '9': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('b'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), zen = require('l'), contains = require('1b'), size = require('1c'), trim = require('6'), forEach = require('1d'), getAjaxSuffix = require('8'), Builder = require('1e'), History = require('1f'), LMHistory = require('1g'), LayoutManager = require('1h'), SaveState = require('1i');
        require('h');
    ...
    'a': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), MenuManager = require('1j'), $ = require('1'), zen = require('l'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), deepEquals = require('1k'), trim = require('6'), clamp = require('1l'), contains = require('1b'), getAjaxSuffix = require('8');
        var menumanager, map;
    ...
    'b': function (require, module, exports, global) {
        'use strict';
        var $ = require('n');
        var trim = require('y'), forEach = require('13'), filter = require('19'), indexOf = require('1a');
        $.implement({
    ...
    'g': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('b'), storage = require('1m'), deepEquals = require('1k'), invoke = require('1p'), History = require('1f');
    ...
    'i': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1q'), zen = require('l'), domready = require('2'), storage = require('1m')(), modal = require('4').modal, size = require('1c'), merge = require('1x'), guid = require('1z'), toQueryString = require('20'), contains = require('21'), request = require('3')(), History = require('1f'), getAjaxSuffix = require('8'), mm = require('a');
        require('h');
        var ERROR = false;
    ...
    'j': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('b'), modal = require('4').modal, contains = require('1b'), forEach = require('1d');
        require('h');
    ...
    'n': function (require, module, exports, global) {
        'use strict';
        var prime = require('s');
        var forEach = require('13'), map = require('1n'), filter = require('19'), every = require('2e'), some = require('2f');
    ...
    'p': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), ready = require('2'), zen = require('l'), sifter = require('2g'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), $ = require('1q'), moofx = require('m'), bind = require('1t'), forEach = require('1d'), indexOf = require('2h'), last = require('1w'), debounce = require('2i'), isArray = require('2j'), isBoolean = require('2k'), merge = require('1x'), unset = require('2l'), size = require('2m'), values = require('2n'), escapeHTML = require('2o'), trim = require('6');
    ...
    't': function (require, module, exports, global) {
        'use strict';
        var indexOf = require('1a'), forEach = require('13');
    ...
    '1e': function (require, module, exports, global) {
        ...
        var forOwn = require('32'), forEach = require('1d'), size = require('1c'), isArray = require('2j'), flatten = require('34'), guid = require('1z'), set = require('35'), unset = require('2l'), get = require('15'), deepFillIn = require('36'), omit = require('37');
        require('b');
        require('f');
    ...
    '1g': function (require, module, exports, global) {
        var prime = require('s'), Emitter = require('t'), slice = require('3a'), merge = require('1x'), deepEquals = require('1k');
    ...
    '1h': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1q'), zen = require('l'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), Blocks = require('33'), DragDrop = require('3c'), Resizer = require('3d'), Eraser = require('3e'), get = require('15'), keys = require('3f'), every = require('3g'), precision = require('3h'), isArray = require('2j'), deepEquals = require('1k'), find = require('3i'), isObject = require('3j');
        var singles = {
                disable: function () {
    ...
    '1j': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1q'), zen = require('l'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), DragDrop = require('3c'), Resizer = require('3m'), get = require('15'), every = require('3g'), isArray = require('2j'), isObject = require('3j'), deepClone = require('3k'), equals = require('3n');
    ...
    '22': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), $ = require('1'), ready = require('2'), zen = require('l'), DragEvents = require('40'), forEach = require('1d'), bind = require('1t'), clamp = require('1l');
        var isFirefox = navigator.userAgent.toLowerCase().indexOf('firefox') > -1;
    ...
    '23': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1q'), zen = require('l'), storage = require('1m')(), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), domready = require('2'), bind = require('1t'), map = require('1u'), forEach = require('1v'), contains = require('1b'), last = require('1w'), split = require('41'), removeAll = require('42'), insert = require('43'), find = require('44'), combine = require('45'), merge = require('1x'), unhyphenate = require('46'), properCase = require('47'), trim = require('6'), modal = require('4').modal, async = require('48'), request = require('3'), wf = require('49');
        require('4a');
        var Fonts = new prime({
                mixin: Bound,
                inherits: Emitter,
    ...
    '25': function (require, module, exports, global) {
        'use strict';
        var $ = require('1q'), domready = require('2'), modal = require('4').modal, getAjaxSuffix = require('8'), getAjaxURL = require('4b').global, trim = require('6'), contains = require('1b');
        domready(function () {
            var body = $('body');
    ...
    '26': function (require, module, exports, global) {
        'use strict';
        var $ = require('1q'), prime = require('s'), request = require('3'), zen = require('l'), domready = require('2'), bind = require('1t'), rtrim = require('18'), deepClone = require('3k'), deepFillIn = require('36'), modal = require('4').modal, getAjaxSuffix = require('8'), getAjaxURL = require('4b').global, dropzone = require('4c');
    ...
    '28': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('1'), zen = require('l'), has = require('4e'), some = require('4f'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), indexOf = require('2h'), contains = require('1b'), lastItem = require('1w'), simpleSort = require('4d'), escapeUnicode = require('4g'), trim = require('6'), getAjaxSuffix = require('8');
        require('e');
        ready(function () {
            var body = $('body');
            var createSortables = function (list) {
    ...
    '2s': function (require, module, exports, global) {
        'use strict';
        var kindOf = require('2r'), now = require('4s'), forEach = require('13'), indexOf = require('1a');
        var callbacks = {
                timeout: {},
                frame: [],
                immediate: []
    ...
    '30': function (require, module, exports, global) {
        var identity = require('4t');
        var prop = require('4u');
        var deepMatches = require('4v');
    ...
    '3c': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), bind = require('1t'), contains = require('1b'), DragEvents = require('40'), $ = require('1q');
        require('c');
        require('d');
    ...
    '3d': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('40'), prime = require('s'), Emitter = require('t'), Bound = require('1r'), Options = require('1s'), bind = require('1t'), isString = require('5c'), nMap = require('5d'), clamp = require('1l'), precision = require('3h'), get = require('15'), $ = require('1q');
        require('c');
        require('d');
    ...
    '3k': function (require, module, exports, global) {
        var clone = require('5g');
        var forOwn = require('32');
        var kindOf = require('5h');
        var isPlainObject = require('5a');
    ...
    '4x': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Options = require('1s'), Bound = require('1r'), Emitter = require('t'), guid = require('1z'), zen = require('l'), $ = require('1'), get = require('15'), has = require('4e'), set = require('35');
        require('f');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '4y': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1'), Base = require('4x'), zen = require('l'), getAjaxURL = require('4b').config;
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '4z': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Base = require('4x'), Bound = require('1r'), Grid = require('51'), $ = require('1'), zen = require('l'), bind = require('1t'), getAjaxURL = require('4b').config;
        require('e');
        var UID = 0;
    ...
    '50': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Section = require('4z');
    ...
    '51': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Base = require('4x'), $ = require('1'), getAjaxURL = require('4b').config;
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '52': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Base = require('4x'), $ = require('1');
    ...
    '53': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Base = require('4x'), $ = require('1q'), zen = require('l'), precision = require('3h'), bind = require('1t');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '54': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), $ = require('1'), Atom = require('4y'), bind = require('1t'), precision = require('3h'), getAjaxURL = require('4b').config;
        var UID = 0;
    ...
    '55': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), trim = require('6'), Particle = require('54');
        var UID = 0;
    ...
    '56': function (require, module, exports, global) {
        'use strict';
        var prime = require('s'), Particle = require('54');
