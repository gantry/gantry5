...
(function (modules, global) {
    ...
    '7': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('9'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), zen = require('j'), contains = require('16'), size = require('17'), trim = require('18'), getAjaxSuffix = require('6'), Builder = require('19'), History = require('1a'), LMHistory = require('1b'), LayoutManager = require('1c'), SaveState = require('1d');
        require('f');
    ...
    '8': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), MenuManager = require('14'), $ = require('1'), zen = require('j'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), deepEquals = require('15'), getAjaxSuffix = require('6');
        var menumanager, map;
        ready(function () {
            var body = $('body');
    ...
    'e': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('9'), storage = require('1g'), deepEquals = require('15'), invoke = require('1j'), History = require('1a');
    ...
    'g': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), $ = require('1k'), zen = require('j'), domready = require('2'), storage = require('1g')(), modal = require('4').modal, size = require('17'), merge = require('1r'), guid = require('1t'), toQueryString = require('1u'), request = require('3')(), History = require('1a'), getAjaxSuffix = require('6'), mm = require('8');
        require('f');
        var ERROR = false;
    ...
    'h': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), $ = require('9'), modal = require('4').modal, toastr = require('4').toastr, request = require('3'), zen = require('j'), contains = require('16'), size = require('17'), getAjaxSuffix = require('6');
        require('f');
        ready(function () {
            var body = $('body');
    ...
    'z': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), ready = require('2'), zen = require('j'), sifter = require('2h'), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), $ = require('1k'), moofx = require('k'), bind = require('1n'), forEach = require('2i'), indexOf = require('2j'), last = require('1q'), debounce = require('2k'), isArray = require('2l'), isBoolean = require('2m'), merge = require('1r'), unset = require('2n'), size = require('2o'), values = require('2p'), escapeHTML = require('2q'), trim = require('18');
    ...
    '14': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), $ = require('1k'), zen = require('j'), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), DragDrop = require('2s'), Resizer = require('2t'), get = require('13'), every = require('2u'), isArray = require('2l'), isObject = require('2v'), deepClone = require('2w'), equals = require('2x');
    ...
    '15': function (require, module, exports, global) {
        ...
        var objEquals = require('2x');
        var arrEquals = require('2z');
    ...
    '19': function (require, module, exports, global) {
        ...
        var forOwn = require('31'), forEach = require('2i'), size = require('17'), isArray = require('2l'), flatten = require('32'), guid = require('1t'), set = require('33'), unset = require('2n'), get = require('13'), deepFillIn = require('34'), omit = require('35');
        require('9');
        require('d');
    ...
    '1b': function (require, module, exports, global) {
        var prime = require('m'), Emitter = require('n'), slice = require('3c'), merge = require('1r'), deepEquals = require('15');
    ...
    '1c': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), $ = require('1k'), zen = require('j'), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), Blocks = require('30'), DragDrop = require('2s'), Resizer = require('2t'), Eraser = require('3d'), get = require('13'), keys = require('3e'), every = require('2u'), precision = require('3f'), isArray = require('2l'), deepEquals = require('15'), find = require('3g'), isObject = require('2v');
        var singles = {
                disable: function () {
    ...
    '1d': function (require, module, exports, global) {
        var prime = require('m'), deepClone = require('2w'), objectDiff = require('3h');
    ...
    '1w': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), $ = require('1k'), zen = require('j'), storage = require('1g')(), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), domready = require('2'), bind = require('1n'), map = require('1o'), forEach = require('1p'), contains = require('16'), last = require('1q'), split = require('3t'), removeAll = require('3u'), insert = require('3v'), find = require('3w'), combine = require('3x'), merge = require('1r'), unhyphenate = require('3y'), properCase = require('3z'), trim = require('18'), modal = require('4').modal, async = require('40'), request = require('3'), wf = require('41');
        require('42');
        var Fonts = new prime({
                mixin: Bound,
                inherits: Emitter,
    ...
    '1y': function (require, module, exports, global) {
        'use strict';
        var $ = require('1k'), domready = require('2'), modal = require('4').modal, getAjaxSuffix = require('6'), getAjaxURL = require('43').global, trim = require('18'), contains = require('16');
        domready(function () {
            var body = $('body');
    ...
    '2s': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), bind = require('1n'), contains = require('16'), DragEvents = require('3r'), $ = require('1k');
        require('a');
        require('b');
    ...
    '2t': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('3r'), prime = require('m'), Emitter = require('n'), Bound = require('1l'), Options = require('1m'), bind = require('1n'), isString = require('4i'), nMap = require('4j'), clamp = require('3s'), precision = require('3f'), get = require('13'), $ = require('1k');
        require('a');
        require('b');
    ...
    '2w': function (require, module, exports, global) {
        var clone = require('4k');
        var forOwn = require('31');
        var kindOf = require('4l');
        var isPlainObject = require('4m');
    ...
    '4o': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Options = require('1m'), Bound = require('1l'), Emitter = require('n'), guid = require('1t'), zen = require('j'), $ = require('1'), get = require('13'), has = require('4h'), set = require('33');
        require('d');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '4p': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Base = require('4o'), zen = require('j'), getAjaxURL = require('43').config;
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '4q': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Base = require('4o'), Bound = require('1l'), Grid = require('4s'), $ = require('1'), zen = require('j'), bind = require('1n'), getAjaxURL = require('43').config;
        require('c');
        var UID = 0;
    ...
    '4s': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Base = require('4o'), $ = require('1'), getAjaxURL = require('43').config;
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '4u': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Base = require('4o'), $ = require('1k'), zen = require('j'), precision = require('3f'), bind = require('1n');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '4v': function (require, module, exports, global) {
        'use strict';
        var prime = require('m'), Atom = require('4p'), bind = require('1n'), precision = require('3f'), getAjaxURL = require('43').config;
        var UID = 0;
