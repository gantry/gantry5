...
(function (modules, global) {
    ...
    'h': function (require, module, exports, global) {
        'use strict';
        var prime = require('o');
        var forEach = require('j'), map = require('z'), filter = require('k'), every = require('1q'), some = require('1r');
    ...
    'm': function (require, module, exports, global) {
        ...
        var prime = require('o'), defer = require('1x');
    ...
    'y': function (require, module, exports, global) {
        ...
        var isObject = require('2a'), isString = require('2b'), isArray = require('2c'), isFunction = require('2d'), trim = require('i'), upperCase = require('2e'), forIn = require('2f'), mixIn = require('1z'), remove = require('2g'), forEach = require('j');
    ...
    '10': function (require, module, exports, global) {
        'use strict';
        module.exports = 'document' in global ? require('2h') : { parse: require('1p') };
    },
    ...
    '19': function (require, module, exports, global) {
        var prime = require('o'), Emitter = require('m'), slice = require('24'), merge = require('w'), deepEquals = require('33');
    ...
    '1a': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), $ = require('p'), zen = require('f'), Emitter = require('m'), Bound = require('q'), Options = require('r'), Blocks = require('2t'), DragDrop = require('34'), Resizer = require('35'), Eraser = require('36'), get = require('2y'), every = require('37'), precision = require('38'), isArray = require('2i'), isObject = require('28');
        var singles = {
                disable: function () {
    ...
    '1b': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), $ = require('p'), zen = require('f'), Emitter = require('m'), Bound = require('q'), Options = require('r'), DragDrop = require('34'), Resizer = require('35'), get = require('2y'), every = require('37'), isArray = require('2i'), isObject = require('28'), equals = require('39');
    ...
    '1d': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), ready = require('d'), zen = require('f'), sifter = require('3a'), Emitter = require('m'), Bound = require('q'), Options = require('r'), $ = require('p'), moofx = require('g'), bind = require('s'), forEach = require('2u'), indexOf = require('2o'), last = require('v'), debounce = require('3b'), isArray = require('2i'), isBoolean = require('3c'), merge = require('w'), unset = require('2x'), size = require('2j'), values = require('3d'), escapeHTML = require('3e'), trim = require('17');
    ...
    '1g': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Emitter = require('m'), Bound = require('q'), Options = require('r'), $ = require('1'), ready = require('d'), zen = require('f'), DragEvents = require('3f'), forEach = require('2u'), bind = require('s'), clamp = require('3g');
    ...
    '1h': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), $ = require('p'), zen = require('f'), storage = require('n')(), Emitter = require('m'), Bound = require('q'), Options = require('r'), domready = require('d'), bind = require('s'), map = require('t'), forEach = require('u'), contains = require('16'), last = require('v'), split = require('3h'), removeAll = require('3i'), insert = require('3j'), find = require('3k'), combine = require('3l'), merge = require('w'), unhyphenate = require('3m'), properCase = require('3n'), trim = require('17'), modal = require('b').modal, async = require('3o'), request = require('y'), wf = require('3p');
        require('3q');
        var Fonts = new prime({
                mixin: Bound,
                inherits: Emitter,
    ...
    '1x': function (require, module, exports, global) {
        'use strict';
        var kindOf = require('21'), now = require('46'), forEach = require('j'), indexOf = require('l');
        var callbacks = {
                timeout: {},
                frame: [],
                immediate: []
    ...
    '34': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Emitter = require('m'), Bound = require('q'), Options = require('r'), bind = require('s'), contains = require('16'), DragEvents = require('3f'), $ = require('p');
        require('3');
        require('4');
    ...
    '35': function (require, module, exports, global) {
        'use strict';
        var DragEvents = require('3f'), prime = require('o'), Emitter = require('m'), Bound = require('q'), Options = require('r'), bind = require('s'), isString = require('54'), nMap = require('55'), clamp = require('3g'), precision = require('38'), get = require('2y'), $ = require('p');
        require('3');
        require('4');
    ...
    '4l': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Options = require('r'), Bound = require('q'), Emitter = require('m'), guid = require('12'), zen = require('f'), $ = require('1'), get = require('2y'), has = require('4z'), set = require('2w');
        require('6');
        var Base = new prime({
                mixin: [
                    Bound,
    ...
    '4m': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Base = require('4l'), getAjaxURL = require('3r').config;
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '4n': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Base = require('4l'), Bound = require('q'), Grid = require('4p'), $ = require('1'), zen = require('f'), bind = require('s'), getAjaxURL = require('3r').config;
        require('5');
        var UID = 0;
    ...
    '4o': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Section = require('4n');
    ...
    '4p': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Base = require('4l'), $ = require('1'), getAjaxURL = require('3r').config;
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '4q': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Base = require('4l'), $ = require('1');
    ...
    '4r': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Base = require('4l'), $ = require('p'), zen = require('f'), precision = require('38');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '4s': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Atom = require('4m'), bind = require('s'), precision = require('38'), getAjaxURL = require('3r').config;
        var UID = 0;
    ...
    '4t': function (require, module, exports, global) {
        'use strict';
        var prime = require('o'), Particle = require('4s');
        var UID = 0;
