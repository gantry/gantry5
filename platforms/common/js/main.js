...
(function (modules, global) {
    ...
    '35': function (require, module, exports, global) {
        'use strict';
        var prime = require('k'), Options = require('v'), Bound = require('u'), Emitter = require('g'), guid = require('q'), zen = require('m'), $ = require('1'), get = require('2c'), has = require('3i'), set = require('2a');
        require('6');
        var Base = new prime({
                mixin: [
                    Bound,
