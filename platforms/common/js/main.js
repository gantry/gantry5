...
(function (modules, global) {
    ...
    '4q': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), $ = require('1'), Base = require('4p'), zen = require('k'), getAjaxURL = require('49').config;
        var Atom = new prime({
                inherits: Base,
                options: { type: 'atom' },
                constructor: function (options) {
    ...
    '4r': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), Base = require('4p'), Bound = require('1q'), Grid = require('4t'), $ = require('1'), zen = require('k'), bind = require('1s'), getAjaxURL = require('49').config;
        require('d');
        var UID = 0;
    ...
    '4t': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), Base = require('4p'), $ = require('1'), getAjaxURL = require('49').config;
        var Grid = new prime({
                inherits: Base,
                options: { type: 'grid' },
                constructor: function (options) {
    ...
    '4v': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), Base = require('4p'), $ = require('1p'), zen = require('k'), precision = require('3e'), bind = require('1s');
        var Block = new prime({
                inherits: Base,
                options: {
                    type: 'block',
    ...
    '4w': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), $ = require('1'), Atom = require('4q'), bind = require('1s'), precision = require('3e'), getAjaxURL = require('49').config;
        var UID = 0;
    ...
    '4x': function (require, module, exports, global) {
        'use strict';
        var prime = require('r'), trim = require('6'), Particle = require('4w');
        var UID = 0;
