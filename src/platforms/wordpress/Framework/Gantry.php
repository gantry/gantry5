...
class Gantry extends Base\Gantry
{
    ...
    protected static function load()
    {
        ...
        if ( !class_exists( 'Timber' ) ) {
            throw new \LogicException( 'Timber not activated. Make sure you activate the plugin on the <a href="' . admin_url( 'plugins.php#timber' ) . '"><strong>Installed Plugins</strong></a> page.' );
        }
