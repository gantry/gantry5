<?php
/**
 * Private distribution only: remote update metadata for the Hydrogen theme.
 */

defined('ABSPATH') || die;

add_filter('pre_set_site_transient_update_themes', 'g5_hydrogen_private_theme_updates');
 ...
 * @return string
 */
function g5_hydrogen_private_normalize_version($version)
{
...
/**
 * Inject update metadata for the private Hydrogen distribution.
 *
 * @param object $transient Theme update transient.
 * @return object
 */
function g5_hydrogen_private_theme_updates($transient)
{
    ...
    $slug = 'g5_hydrogen';
    $url = 'https://updates.gantry.org/wp-updates/g5_hydrogen_copy.json';
    ...
    $installed_stable_version = g5_hydrogen_private_normalize_version($installed_version);
    $available_stable_version = g5_hydrogen_private_normalize_version($available_version);
