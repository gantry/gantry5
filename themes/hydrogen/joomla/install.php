...
return new class () implements ServiceProviderInterface
{
    ...
    {
        $container->set(InstallerScriptInterface::class, new class ($container) implements InstallerScriptInterface {
            /**
            ...
            {
                $this->app = $container->get(AdministratorApplication::class);
