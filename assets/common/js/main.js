...
(function (modules, global) {
    ...
    '1': function (require, module, exports, global) {
        'use strict';
        var ready = require('2'), prime = require('3'), $ = require('4'), zen = require('5');
        var Menu = new prime({
                options: {
                    submenu: {
                        dir: 'right',
        ...
        ready(function () {
            ...
            var nav = $('nav.g-main-nav'), target = $('#g-mobilemenu-container'), clone = nav[0].cloneNode(true);
            $(clone).bottom(target);
        });
        module.exports = {};
    },
    ...
    '3': function (require, module, exports, global) {
        'use strict';
        var hasOwn = require('6'), mixIn = require('7'), create = require('8'), kindOf = require('9');
    ...
    '5': function (require, module, exports, global) {
        'use strict';
        var forEach = require('g'), map = require('h');
        var parse = require('i');
        var $ = require('a');
    ...
    'a': function (require, module, exports, global) {
        'use strict';
        var prime = require('3');
        var forEach = require('g'), map = require('h'), filter = require('k'), every = require('l'), some = require('m');
    ...
    'b': function (require, module, exports, global) {
        'use strict';
        var $ = require('a');
        var trim = require('n'), forEach = require('g'), filter = require('k'), indexOf = require('o');
        $.implement({
    ...
    'n': function (require, module, exports, global) {
        var toString = require('w');
        var WHITE_SPACES = require('x');
        var ltrim = require('y');
        var rtrim = require('z');
    ...
    'p': function (require, module, exports, global) {
        'use strict';
        var indexOf = require('o'), forEach = require('g');
        var prime = require('3'), defer = require('v');
    ...
    'q': function (require, module, exports, global) {
        'use strict';
        module.exports = 'document' in global ? require('u') : { parse: require('i') };
    },
    'r': function (require, module, exports, global) {
        'use strict';
        var indexOf = require('o');
        var prime = require('3');
        var Map = prime({
    ...
    's': function (require, module, exports, global) {
        var identity = require('10');
        var prop = require('11');
        var deepMatches = require('12');
    ...
    'v': function (require, module, exports, global) {
        'use strict';
        var kindOf = require('9'), now = require('13'), forEach = require('g'), indexOf = require('o');
        var callbacks = {
                timeout: {},
                frame: [],
                immediate: []
