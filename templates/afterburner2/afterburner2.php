		...
		<div class="container">			
			<div class="grid pure-g-r">
				<div class="block pure-u-2-3">
					<section id="main">
						<div class="content">
							<h2 class="title">Popular Features</h3>
							<div class="rt-relative largemarginbottom  largepaddingbottom largepaddingright rt-border-right rt-border-bottom">
								<div class="rt-big-icon rt-blue fa fa-cogs"></div>
								<h5 class="smallmarginbottom nomargintop">Framework</h5>
								<em><small>Advanced Features</small></em>
								<p>Gantry provides the template foundation, with its standard set of features, such as the advanced template manager.</p>
								<p><a href="http://gantry-framework.org/" class="readon">Read More</a></p>
							</div>

							<h2 class="title">Template Extras</h3>
							<div class="grid pure-g-r">
								<div class="block pure-u-1-2"><div class="gantry-width-spacer">
									<div class="rt-relative largemarginbottom largepaddingright rt-border-right rt-border-bottom">
										<p>Afterburner2 is an experiment in how streamlined a Gantry template can be whilst still being stunning and usable. Many extras have been removed, but still contains styling for major elements.</p>
									</div>
								</div></div>

								<div class="block pure-u-1-2"><div class="gantry-width-spacer">
									<div class="rt-relative largemarginbottom largepaddingright rt-border-right rt-border-bottom">
										<div class="rt-small-icon rt-red fa fa-tasks"></div>
										<h5 class="smallmarginbottom nomargintop">Dropdowns</h5>
										<p>A CSS based dropdown menu system.</p>
									</div>
								</div></div>
							</div>
							<div class="grid pure-g-r">
								<div class="block pure-u-1-2"><div class="gantry-width-spacer">
									<div class="rt-relative largemarginbottom largepaddingright rt-border-right">
										<div class="rt-small-icon rt-grey fa fa-list"></div>
										<h5 class="smallmarginbottom nomargintop">Typography</h5>
										<p>Elements are styled by a streamlined version of Bootstrap.</p>
									</div>
								</div></div>

								<div class="block pure-u-1-2"><div class="gantry-width-spacer">
									<div class="rt-relative largemarginbottom largepaddingright rt-border-right">
										<div class="rt-small-icon rt-blue fa fa-edit"></div>
										<h5 class="smallmarginbottom nomargintop">Optimized</h5>
										<p>Afterburner2 has only one image, which is 3KB in size.</p>
									</div>
								</div></div>
							</div>
						</div>
				...
				<div class="block size-1-3 pure-1-3">
					<section id="sidebar">
						<div class="content">
							...
							<p><a class="readon" href="/live/joomla/afterburner2/presets">Read More</a></p>
						</div>
						<div class="content box1">
							<h2 class="title">Module Variations</h2>
							...
							<a href="/live/joomla/afterburner2/features/module-variations" class="readon"><span>Read More</span></a>
						</div>
					</section>
				</div>
			</div>
					...
					<div class="block pure-u-1">
						<div class="content">
							<div class="rt-copyright-block">
								<a href="#">Designed by RocketTheme</a>
							</div>
						</div>
					</div>
				</div>
